...
Naz = ceil(Ls/Vr*Fa*1.5);% 有效数据两边各区各加五分之一的宽度
NFFT_r = Nrg;           % 距离向FFT长度
NFFT_a = Naz;           % 方位向FFT长度
%%
% --------------------------------------------------------------------
...
target_1 = target_analysis( s_ac((Naz/2+1)-NN:(Naz/2+1)+NN,250-NN:250+NN),Fr,Fa,Vr,L_range,L_azimuth);
% 
